...
#define ID_MESH_NUMBONE			_T("*MESH_NUMBONE")
#define ID_MESH_NUMSKINWEIGHT	_T("*MESH_NUMSKINWEIGHT")
#define ID_BONE_LIST			_T("*BONE_LIST")
#define ID_BONE					_T("*BONE")
#define ID_BONE_NAME			_T("*BONE_NAME")
#define ID_BONE_PROPERTY		_T("*BONE_PROPERTY")
#define ID_MESH_WVERTEXS		_T("*MESH_WVERTEXS")
#define ID_MESH_WEIGHT			_T("*MESH_WEIGHT")
#define ID_BONE_BLENGING_WEIGHT	_T("*BONE_BLENGING_WEIGHT")
#define ID_SKIN_INITTM			_T("*SKIN_INITTM")
...
#define ID_MESHFRAMESTEP		_T("*SCENE_MESHFRAMESTEP")
#define ID_KEYFRAMESTEP			_T("*SCENE_KEYFRAMESTEP")
...
#define ID_PROP_HIDDEN			_T("*PROP_HIDDEN")
#define ID_PROP_NORENDERABLE	_T("*PROP_NORENDERABLE")
#define ID_PROP_BONE			_T("*PROP_BONE")
