...
public:
	...
	inline BOOL			GetIncludeSkinningInfo()			{ return bIncludeSkinningInfo; }
	...
	inline void			SetIncludeSkinningInfo(BOOL val)	{ bIncludeSkinningInfo = val; }
