...
cASELexer::cASELexer(LPCTSTR p_FileName, DWORD p_SizeOfBuffer) : cLexer(p_FileName, p_SizeOfBuffer)
{
}
...
//Lexical Analysis
LONG cASELexer::GetToken(LPSTR p_TokenString)
{
	// 1) 앞쪽 쓸데없는 문자찾기
	...
	TRACE1(_T("Have no match token : %s\n"), p_TokenString);
	return TOKEND_NOTDEFINED;
}
