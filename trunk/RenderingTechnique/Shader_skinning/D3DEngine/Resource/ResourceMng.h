...
public:		
	...
	cRscVertexBuffer*	CreateRscVertexBuffer(DWORD bufferSize,UINT nUniqueNumber=0);
	cRscIndexBuffer*	CreateRscIndexBuffer(DWORD bufferSize,UINT nUniqueNumber=0);
