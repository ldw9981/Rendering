...
cLexer::cLexer(LPCTSTR p_FileName, DWORD p_SizeOfBuffer)
{
	m_File				 = NULL;
...
{
	// CASE 1) Buffer의 끝에 다았으면 다시 File로 부터 Buffer만큼을 읽어 들인다.
...
BOOL cLexer::Open(LPCTSTR p_FileName, DWORD p_SizeOfBuffer)
{
